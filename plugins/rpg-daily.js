...
if (new Date - user.lastclaim < 7200000) return await conn.sendButton(m.chat, `VOCÊ JÁ UTILIZOU ESSE COMANDO, VOLTE EM *${msToTime(time - new Date())}*`, wm, null, [['𝗠 𝗘 𝗡 𝗨 ☘️', '/menu']], fkontak, m)
let texto = ''
...
let text = `
╭━━🎁━🎁━🎁━━⬣
┃ ✨ OBTEVE UMA RECOMPENSA!!
┃ *${premium ? '🎟️ Recompensa vip' : '🆓 Recompensa Gratis'}*
╰━━🎁━🎁━🎁━━⬣`
let img = './Menu.png'

await conn.sendButton(m.chat, text, texto + `\n\n🎟️ VIP ⇢ ${premium ? '✅' : '❌'}\n${wm}`, img, [['⛰️ ABRIR COFRE ⛰️', '/cofre'], ['VOLTAR AO MENU ☘️', '/menu']], m, dos.getRandom())  
