...
if (!/image/g.test(mime)) throw '*[❗] RESPONDA MARCANDO UMA IMAGEM*'
m.reply('*[❗] ESTOU CONVERTENDO A IMAGEM PARA FORMATO DE ANIME, AGUARDE*')    
...
throw '*[❗] DEU ERRO, nada funciona por aqui...*'
}}}}
