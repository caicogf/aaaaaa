...
if(number.length > 13 || (number.length < 11 && number.length > 0)) return conn.reply(m.chat, `*[ ⚠️ ] botou o nome errado, incompetente. Espero que o próximo adm seja melhor*`, m)
